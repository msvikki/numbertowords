...
// MaxNumber is the largest number that this version of numbertowords can convert into words.
const MaxNumber = 99999

// Convert converts an integer number between 0 to MaxNumber to words.
